...
* Run `databricks configure --profile finalTestProject-dev --token --host <your-dev-workspace-url>`, passing the URL of your dev workspace.
...
If you already have CI/CD setup in a separate repo:
