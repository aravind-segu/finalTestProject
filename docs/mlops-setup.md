...
If adding CI/CD to a project directory, commit the new changes to github and manually run the `deoply-cicd.yml` file from the Github Actions UI to initalize all the files required for CICD.
